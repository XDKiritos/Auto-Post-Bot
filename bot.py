...
# Function to send a recurring sticker with a button to multiple groups
async def send_recurring_sticker_with_button():
    while True:
        ...
        for group_chat_id in group_chat_ids:
            await app.send_sticker(group_chat_id, sticker=sticker_file_id, reply_markup=keyboard)
